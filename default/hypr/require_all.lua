...
-- Used for Omybuntu extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/omybuntu/toggles/hypr.
-- Pass a module prefix for normal package.path modules, e.g.
--   require_all.files(paths.omybuntu_path .. "/default/hypr/apps", "default.hypr.apps")
